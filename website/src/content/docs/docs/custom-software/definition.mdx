...
<CodeSnippet file="examples/software/definition-server.ts" />
...
<CodeSnippet file="examples/software/definition-pi.ts" />
...
<CodeSnippet file="examples/software/definition-my-tool.ts" />
...
<CodeSnippet file="examples/software/definition-my-commands.ts" />
